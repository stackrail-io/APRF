...
assert(
  PROFILE_REGULATED.mandatoryCheckIds.length === 52,
  `Regulated profile expected 52, got ${PROFILE_REGULATED.mandatoryCheckIds.length}`,
);
assert(getTier3OnlyMandatoryIds().length === 14, "tier3-only count");
