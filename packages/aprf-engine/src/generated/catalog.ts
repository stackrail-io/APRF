  ...
  "rules": [
    {
      ...
      "detection": {
        ...
        "detectors": [
          ...
          },
          {
            "id": "manual-attest",
            "params": {
              "hint": "If automation cannot prove inventory completeness, attest a versioned production-agent inventory with charter fields (purpose, owner, production identifier, lifecycle status, approved tool policy, data scope, autonomy boundaries, change control, review date, last updated, charter version, structured approval) and completeness evidence from a runtime registry, deployment manifest, CMDB, platform registry, or approved attestation. Escalate finding severity to critical when completeness or ownership cannot be demonstrated.\n"
            }
          }
        ]
      },
      "manualVerification": "1) Confirm this target is a production agent runtime (or multi-agent / autonomous workflow / MCP-or-A2A runtime with autonomous behavior)—not an agent framework, SDK, or library alone. Define “production agent” for this system. 2) Build or export a version-controlled inventory of those agents with owners and a production identifier (environment, system, application, or deployment id). 3) For each inventory row, open the linked charter and verify it states: purpose/goals; lifecycle status (Active / Deprecated / Retired / Experimental); approved tool policy reference; data/corpora scope; autonomy boundaries (e.g. execution bounds per AGN-M2); named owner; change justification or revision history for autonomy/tool-policy changes; review date; last updated; charter version; structured approval (approvedBy, approvalDate, approvalStatus). Optional: riskLevel (Low / Medium / High / Critical) for review cadence. 4) Verify runtime configuration is consistent with the approved charter; material deviations require charter review before deployment. 5) PASS only if completeness is demonstrated via runtime registry, deployment manifest, CMDB, platform registry, or approved attestation (≤90 days) and 0 production agents are missing required fields. Named exceptions need business justification, approver, expiry ≤90 days, and compensating controls. 6) Treat the finding as Critical (not High) when production agents cannot be enumerated, completeness cannot be established, autonomous agents have no accountable owner, or unknown/shadow production agents are present.",
      "falsePositiveGuidance": "Do not fail agent frameworks, SDKs, libraries, inference-only services, embeddings, classifiers, or rerankers that are not deployed production agent runtimes—score NOT_APPLICABLE. Do not pass on architecture or design docs that name agent types without a current inventory (registry/CMDB/manifest export ≤90 days) of deployed production agents. Do not treat a type-level row as covering every deployed instance. Chatbots without tool/autonomy loops are out of scope unless your documented production-agent definition includes them. A tool allowlist in code does not satisfy this Check unless each charter references it. Stub charters (empty purpose, unset owner, missing autonomy limits, missing lifecycle/change-control/approval metadata) fail. Passing step-limit or kill-switch Checks does not substitute for charters. Do not score Critical solely because a known, owned agent is missing a polished charter while inventory completeness and ownership remain proven—that is High governance debt. Named exceptions need business justification, approver, compensating controls, and expiry ≤90 days—not owner alone.",
      "recommendedFixes": [
        "Create a single agent inventory (registry, CMDB table, or repo manifest) that lists every production agent with owner, production identifier, lifecycle status, and charter link",
        "Adopt the APRF agent charter spec (skills/aprf-auditor/examples/agent-charter/agent-charter.spec.yaml) with fields agentVersion, id, owner, environment/system/application/deploymentId, lifecycleStatus, purpose, allowedTools, forbiddenTools, dataScope, memoryPolicy, networkPolicy, autonomy, approval.{approvedBy,approvalDate,approvalStatus}, changeJustification or revisionHistory, optional riskLevel, identityPolicy, loggingPolicy, reviewDate, lastUpdated, expiryDate; migrate existing agents onto it",
        "Gate new agent promotion to production on inventory + charter completeness and runtime↔charter consistency (fail closed when fields are missing or runtime diverges)",
        "Schedule a recurring inventory audit (≤90 days) with a named owner; retire or deprecate abandoned agents via lifecycleStatus; escalate to Critical when completeness or ownership cannot be demonstrated"
      ],
      "references": [
        {
      ...
      "applicability": {
        ...
        "appliesTo": [
          ...
          "MCP clients with autonomous behavior",
          "MCP servers with autonomous behavior",
          "A2A runtimes"
        ],
        "notApplicableTo": [
          "agent frameworks",
      ...
      "detection": {
        ...
        "detectors": [
          ...
          },
          {
            "id": "manual-attest",
            "params": {
              "hint": "If automation cannot see runtime enforcement, attest finite iteration and duration bounds (plus recursion/delegation depth when spawning or sub-agents are supported), abort-on-exceed tests that prove no continue-after-abort, and preferably runtime logs of limit-triggered termination for every production agent runtime.\n"
            }
          }
        ]
      },
      "manualVerification": "1) Inventory production agent runtimes (same scope as the charter inventory). Score NOT_APPLICABLE if the system has only simple chat-completion / single inference / embedding / classifier / reranker paths with no multi-step tool or delegation autonomy. 2) For each runtime, map its native controls to Execution Bounds: (a) iteration bound (reasoning/tool iterations, max steps, max tool calls, etc.), (b) duration bound (timeout, deadline, wall-clock, execution_timeout, etc.), (c) recursion/delegation bound when the runtime supports recursive delegation, agent spawning, or sub-agent execution—otherwise mark (c) N/A for that runtime. Confirm each required value is finite and documented; treat missing, null, zero-as-unlimited, Infinity, or “disabled” as fail. 3) Review or run enforcement tests: force each applicable bound to be exceeded; require abort/fail-closed with an observable signal (error, kill, or quarantine). Also verify the agent cannot continue execution after abort (no further planner steps and no leftover background tool/task dispatch). Prompt-only refusals without runtime stop do not pass. 4) Prefer runtime logs showing “terminated due to limit” (or equivalent) for each bound class exercised. PASS only if every production agent runtime meets config + enforcement evidence for all applicable bounds.\n",
      "falsePositiveGuidance": "Do not pass on charter text or system-prompt budgets without runtime enforcement. Do not pass because a framework “supports” limits if production configs leave them unset or infinite (e.g. maxSteps = Infinity). Client-side or SDK defaults that operators can override to unlimited fail unless production platform policy prevents that override. A test that only asserts config keys exist (without exceeding limits) is insufficient. Do not treat model context window or token limits as execution limits—they do not stop unbounded tool calls or recursive planning. Token or cost budgets alone do not satisfy iteration and duration bounds unless mapped 1:1 with abort-on-exceed. Kill-switch or pause capability (AGN-M3) does not substitute for proactive hard limits. Do not fail for missing spawn/delegation depth when the runtime has no recursive delegation, agent spawning, or sub-agent execution capability. Named exceptions need owner and expiry ≤90 days.\n",
      "recommendedFixes": [
  ...
  "crosswalks": [
    {
      ...
      "controls": [
        {
          ...
          "ref": "GOVERN",
          "title": "Govern",
          "summary": "Culture, policies, accountability, and continuous improvement for AI risk."
        },
        {
          "id": "nist-ai-rmf:map",
          "ref": "MAP",
          "title": "Map",
          "summary": "Context, intended use, impacts, and risk categorization."
        },
        {
          "id": "nist-ai-rmf:measure",
          "ref": "MEASURE",
          "title": "Measure",
          "summary": "Quantitative and qualitative assessment of AI risks and trustworthiness."
        },
        {
          "id": "nist-ai-rmf:manage",
          "ref": "MANAGE",
          "title": "Manage",
          "summary": "Prioritize, respond to, and recover from AI risks in operation."
        },
        {
          "id": "nist-ai-rmf:safe",
          "ref": "Safe",
          "title": "Safe",
          "summary": "Trustworthiness characteristic — avoid harmful outcomes under intended use."
        },
        {
          "id": "nist-ai-rmf:secure-resilient",
          "ref": "Secure & Resilient",
          "title": "Secure and Resilient"
        },
        {
          "id": "nist-ai-rmf:explainable",
          "ref": "Explainable",
          "title": "Explainable and Interpretable"
        },
        {
          "id": "nist-ai-rmf:privacy",
          "ref": "Privacy-Enhanced",
          "title": "Privacy-Enhanced"
        },
        {
          "id": "nist-ai-rmf:fair",
          "ref": "Fair",
          "title": "Fair — Harmful Bias Managed"
        },
        {
          "id": "nist-ai-rmf:accountable",
          "ref": "Accountable",
      ...
      "mappings": [
        {
          "peerControlId": "nist-ai-rmf:govern",
          "aprfPillarSlugs": [
            "organizational-governance",
            "compliance",
            "model-governance",
        ...
        {
          "peerControlId": "nist-ai-rmf:measure",
          "aprfPillarSlugs": [
            "evaluation",
            "observability",
            "performance-slo",
        ...
        {
          "peerControlId": "nist-ai-rmf:manage",
          "aprfPillarSlugs": [
            "incident-readiness",
            "change-management",
            "reliability-continuity",
        ...
        {
          "peerControlId": "nist-ai-rmf:safe",
          "aprfPillarSlugs": [
            "safety-responsible-ai",
            "evaluation",
            "human-approval"
        ...
        {
          "peerControlId": "nist-ai-rmf:secure-resilient",
          "aprfPillarSlugs": [
            "ai-security",
            "authentication",
            "authorization",
        ...
        {
          "peerControlId": "nist-ai-rmf:explainable",
          "aprfPillarSlugs": [
            "explainability",
            "observability"
          ],
        ...
        {
          "peerControlId": "nist-ai-rmf:privacy",
          "aprfPillarSlugs": [
            "data-privacy",
            "memory-management",
            "context-engineering"
        ...
        {
          "peerControlId": "nist-ai-rmf:fair",
          "aprfPillarSlugs": [
            "safety-responsible-ai",
            "evaluation",
            "data-governance"
          ...
          "relation": "partial",
          "note": "APRF covers fairness eval gates; organizational bias programs may need extra controls."
        },
        {
          "peerControlId": "nist-ai-rmf:accountable",
          "aprfPillarSlugs": [
            "organizational-governance",
            "human-approval",
            "explainability",
    ...
    },
    {
      "id": "iso-42001",
      "name": "ISO/IEC 42001",
      "peerVersion": "2023 (clause-level conceptual)",
      "url": "https://www.iso.org/standard/81230.html",
      "disclaimer": "Informative alignment only. Does not constitute certification, accreditation, or official endorsement. Not a substitute for a certified AI management system.",
      "controls": [
        {
          "id": "iso-42001:4",
          "ref": "§4",
        ...
        },
        {
          "id": "iso-42001:a",
          "ref": "Annex A",
          "title": "AI system controls (selected themes)",
          "summary": "Mapped thematically to APRF domains — not clause-by-clause Annex A enumeration."
        }
      ],
      "mappings": [
        {
          "peerControlId": "iso-42001:4",
          "aprfPillarSlugs": [
            "organizational-governance",
            "compliance",
            "data-governance"
        ...
        },
        {
          ...
          "relation": "partial",
          "note": "Risk/objectives planning spans org process plus safety and eval gates."
        },
        {
          "peerControlId": "iso-42001:7",
          "aprfPillarSlugs": [
            "platform-engineering",
            "secrets",
            "infrastructure"
          ...
          "relation": "partial",
          "note": "Competence/awareness are org processes; APRF emphasizes platform & secrets support."
        },
        {
          "peerControlId": "iso-42001:8",
          "aprfPillarSlugs": [
            "prompt-engineering",
            "model-governance",
            "change-management",
        ...
        },
        {
          ...
          "relation": "partial",
          "note": "Annex A themes → APRF security, safety, data, model, human oversight, supply chain."
        }
      ]
    },
    {
    ...
    },
    {
      ...
      "peerVersion": "2017 (with 2022 revisions) — evidence reuse",
      "url": "https://www.aicpa-cima.com/topic/audit-assurance/audit-and-assurance-greater-than-soc-2",
      "disclaimer": "Informative alignment only. Does not constitute certification, accreditation, or official endorsement. Passing APRF does not imply SOC 2 compliance.",
      "controls": [
        {
          "id": "soc2:cc1",
          "ref": "CC1",
        ...
        },
        {
          "id": "soc2:p",
          "ref": "P-series",
          "title": "Privacy (selected)"
        }
      ],
      "mappings": [
        {
          "peerControlId": "soc2:cc1",
          "aprfPillarSlugs": [
            "organizational-governance",
            "compliance"
          ],
        ...
        },
        {
          ...
          "relation": "partial",
          "note": "Privacy TSC is broader than APRF privacy checks; use as AI evidence pack only."
        }
      ]
    },
    {
      ...
      "peerVersion": "WA Framework pillars + Generative AI Lens (conceptual)",
      "url": "https://aws.amazon.com/architecture/well-architected/",
      "disclaimer": "Informative alignment only. Does not constitute certification, accreditation, or official endorsement. Not an AWS Well-Architected Lens review or AWS certification.",
      "controls": [
        {
          "id": "aws-wa:ops",
          "ref": "Operational Excellence",
          "title": "Operational Excellence",
          "summary": "Run and monitor systems; continually improve processes."
        },
        {
          "id": "aws-wa:sec",
          "ref": "Security",
          "title": "Security",
          "summary": "Protect data, systems, and assets."
        },
        {
          "id": "aws-wa:rel",
          "ref": "Reliability",
          "title": "Reliability",
          "summary": "Recover from failures and meet demand."
        },
        {
          "id": "aws-wa:perf",
          "ref": "Performance Efficiency",
          "title": "Performance Efficiency",
          "summary": "Use resources efficiently and adapt to demand."
        },
        {
          "id": "aws-wa:cost",
          "ref": "Cost Optimization",
          "title": "Cost Optimization",
          "summary": "Avoid unnecessary cost; manage spend."
        },
        {
          "id": "aws-wa:sus",
          "ref": "Sustainability",
          "title": "Sustainability",
          "summary": "Minimize environmental impact of cloud workloads."
        },
        {
          "id": "aws-wa:genai",
          "ref": "Generative AI Lens",
          "title": "Generative AI Lens (themes)",
          "summary": "Responsible AI, agent/tool safety, eval, and model lifecycle themes."
        }
      ],
      "mappings": [
        {
          "peerControlId": "aws-wa:ops",
          "aprfPillarSlugs": [
            "observability",
            "incident-readiness",
            "change-management",
        ...
        },
        {
          ...
          "relation": "partial",
          "note": "APRF does not define sustainability metrics; cost/routing and model selection are nearest proxies."
        },
        {
          "peerControlId": "aws-wa:genai",
          "aprfPillarSlugs": [
            "safety-responsible-ai",
            "evaluation",
            "agent-governance",
    ...
    },
    {
      ...
      "peerVersion": "v1.0 — conceptual levels / provenance",
      "url": "https://slsa.dev/",
      "disclaimer": "Informative alignment only. Does not constitute certification, accreditation, or official endorsement. APRF alignment does not confer a SLSA level attestation.",
      "controls": [
        {
          "id": "slsa:l1",
          "ref": "Level 1",
          "title": "Build process documented",
          "summary": "Scripted build with provenance documentation."
        },
        {
          "id": "slsa:l2",
          "ref": "Level 2",
          "title": "Hosted build + signed provenance",
          "summary": "Version-controlled, hosted build service; authenticated provenance."
        },
        {
          "id": "slsa:l3",
          "ref": "Level 3",
          "title": "Hardened builds",
          "summary": "Hardened build platform; non-falsifiable provenance."
        },
        {
          "id": "slsa:provenance",
          "ref": "Provenance",
          "title": "Artifact provenance",
          "summary": "Who built what from which source, verifiable at deploy."
        },
        {
          "id": "slsa:verify",
          "ref": "Verify-on-deploy",
          "title": "Verification before use",
          "summary": "Consumers verify signatures/provenance before production use."
        }
      ],
      "mappings": [
        {
          "peerControlId": "slsa:l1",
          "aprfPillarSlugs": [
            "supply-chain",
            "change-management",
            "model-governance"
        ...
        },
        {
          ...
          "relation": "partial",
          "note": "APRF SCI-M4 / hardened admission approximate L3 themes; not a full SLSA L3 claim."
        },
        {
          "peerControlId": "slsa:provenance",
          "aprfPillarSlugs": [
            "supply-chain",
            "model-governance"
          ],
