...
description: >-
  ...
  localhost:3001, no run_* IDs). Prefer `npx @stackrail-io/aprf@0.1.6 audit`.
...
Then dry-run: `npx @stackrail-io/aprf@0.1.6 resolve-target --system-type … --capabilities … --json`.
...
npx @stackrail-io/aprf@0.1.6 resolve-target --system-type <type> --capabilities <caps> --json

# ai-application (example)
npx @stackrail-io/aprf@0.1.6 collect --target . --out ./aprf-assessment
npx @stackrail-io/aprf@0.1.6 assess  --out ./aprf-assessment --system-type ai-application --profile core
npx @stackrail-io/aprf@0.1.6 report  --in ./aprf-assessment/assessment.json --out ./aprf-assessment/REPORT.html
...
If you find yourself opening StackRail Assessments UI, `http://127.0.0.1:3001`, or inventing `run_*` IDs — **stop**. Re-run with this skill and `npx @stackrail-io/aprf@0.1.6 audit`.
