...
| **prompt-model-version-retention** | `prompt-model-version-retention.ts` | prior prompt and/or model-pin versions + restore dry-run per in-scope type (CHG-M1) | `imports/prompt-model-version-retention/` | — |
